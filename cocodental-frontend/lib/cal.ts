...
//   try {
//     let url = `https://api.cal.com/v1/bookings/${bookingUid}/cancel?apiKey=${config.apiKey}`;
...
export async function cancelBookingByUser(
  ...
  try {
    ...
    const requestBody: any = { reason: cancellationReason || "User requested cancellation" };
